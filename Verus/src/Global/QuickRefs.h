...
#define VERUS_QREF_CSMB           World::RCascadedShadowMapBaker csmb     = World::CascadedShadowMapBaker::I()
...
#define VERUS_QREF_SMBP           World::RShadowMapBakerPool     smbp     = World::ShadowMapBakerPool::I()
