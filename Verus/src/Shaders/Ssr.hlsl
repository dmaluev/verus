...
Texture2D    g_texScene    : register(t5, space1);
SamplerState g_samScene    : register(s5, space1);
Texture2D    g_texDepth    : register(t6, space1);
SamplerState g_samDepth    : register(s6, space1);
TextureCube  g_texImage    : register(t7, space1);
SamplerState g_samImage    : register(s7, space1);
