...
void Grass::Draw()
{
	...
	s_ubGrassVS._matWV = wm.GetPassCamera()->GetMatrixV().UniformBufferFormat();
	s_ubGrassVS._matVP = wm.GetPassCamera()->GetMatrixVP().UniformBufferFormat();
	s_ubGrassVS._matP = wm.GetPassCamera()->GetMatrixP().UniformBufferFormat();
